...
* Once you have your `.npmrc` and before you run `npm install` command, replace all occurrences of `@dev-bishal1/shared-library` with your own shared library.
* After replacing all occurrences of `@dev-bishal1/shared-library`, you can then run `npm install` command.
